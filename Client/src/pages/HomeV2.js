...
//       {/* Header */}
//       <header className="relative z-20 px-8 py-4 bg-[#292622c4] backdrop-blur-sm">
...
//           >
//             <img src={logo} alt="XEPHRA Logo" className="h-12 w-32" />
//           </Link>
...
//               )}
//             </button>
//             {/* <Bell className="w-5 h-5 text-[#C9B796] hover:text-white cursor-pointer transition-colors" /> */}
...
//               </button>
//             </div>
//             {/* <span className="text-[#C9B796] text-sm">username</span>
//             <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
//               <User className="w-4 h-4 text-[#C9B796]" />
//             </div> */}
//           </div>
//         </div>
//       </header>
...
//       {/* Mobile Nav Menu */}
//       {isMenuOpen && (
//         <nav className="md:hidden z-30 bg-[#292622c4] backdrop-blur-sm px-8 py-4 space-y-4">
//           {navItems.map((item) => (
//             <button
//               key={item}
//               onClick={() => {
//                 setActiveNav(item);
//                 setIsMenuOpen(false); // Close after selection
//               }}
//               className={`block w-full text-left font-montserrat font-semibold text-lg transition-colors duration-200 ${
//                 activeNav === item
//                   ? "text-white"
//                   : "text-[#D4AD66] hover:text-[#f0cc88]"
//               }`}
...
//       {/* Hero Section */}
//       <section className="relative z-10 px-8 pt-16 pb-8">
//         <div className="max-w-6xl">
//           <div className="mb-6">
//             <span className="font-montserrat drop-shadow-[2px_2px_3px_rgba(0,0,0,0.6)] lg:text-2xl md:text-xl sm:text-lg font-bold mb-4 bg-gradient-to-r from-[#D19F43] via-[#d1a759] to-[#eb9a0d] bg-clip-text text-transparent">
//               #1 Gaming Arena
//             </span>
//           </div>

//           <div className="space-y-2 mb-16">
//             <h1 className="lg:text-6xl md:text-5xl text-3xl font-black leading-none">
...
//               </span>
//             </h1>
//             <h2 className="lg:text-6xl md:text-5xl text-3xl font-black leading-none">
//               <span className="font-montserrat drop-shadow-[2px_2px_3px_rgba(0,0,0,0.6)] mb-2 bg-gradient-to-r from-[#D19F43] via-[#d1a759] to-[#eb9a0d] bg-clip-text text-transparent">
//                 Compete For Glory
//               </span>
//             </h2>
//             <h3 className="lg:text-6xl md:text-5xl text-3xl font-black leading-none text-[#AC5867] mt-4">
//               Enter The Tournament
//             </h3>
//             <h4 className="lg:text-6xl md:text-5xl text-3xl font-black leading-none text-[#AC5867]">
//               Arena
//             </h4>
//           </div>
//         </div>
